...
<?php $__env->startSection('title', 'برامجنا التدريبية'); ?>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- بطاقة البرنامج -->
        <div class="bg-gray-800 rounded-xl overflow-hidden shadow-2xl transition-all duration-300 hover:<?php echo e($ring_color); ?> hover:shadow-xl hover:shadow-<?php echo e($base_color); ?>-500/30 transform hover:scale-[1.02] border border-gray-700">
            <div class="p-6 space-y-3">
                <div class="flex justify-between items-center">
                    <!-- شارة المستوى/الفئة -->
                    <span class="text-xs font-semibold uppercase tracking-wider <?php echo e($text_color); ?> <?php echo e($bg_badge); ?> px-3 py-1 rounded-full whitespace-nowrap"><?php echo e($program['level']); ?></span>
                    <!-- المدة -->
                    <span class="text-sm font-bold text-green-400"><?php echo e($program['duration']); ?></span>
                </div>
                
                <!-- عنوان البرنامج -->
                <h3 class="text-2xl font-bold text-white leading-tight"><?php echo e($program['title']); ?></h3>
                
                <!-- وصف البرنامج -->
                <p class="text-gray-400 text-sm h-12 overflow-hidden"><?php echo e($program['description']); ?></p>
            ...
            <div class="p-4 bg-gray-700 border-t border-gray-600">
                <a href="#" class="block w-full text-center px-4 py-2 <?php echo e($bg_button); ?> text-white font-semibold rounded-lg <?php echo e($hover_button); ?> transition-colors shadow-lg shadow-<?php echo e($base_color); ?>-500/30">
                    عرض التفاصيل
                </a>
            </div>
        </div>
...
<?php echo $__env->make('dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\S I N O\Desktop\projects\KOKGYM\resources\views/user/program.blade.php ENDPATH**/ ?>